    ...
    },
    {
      ...
      svg: (isHovered) => (
        <svg viewBox="0 0 200 200" className="w-full h-full">
          ...
          <text x="100" y="100" fontSize="16" fill="#2196F3" fontWeight="600" textAnchor="middle" opacity="0.6">
            JANUARY
          </text>
          
          <text x="100" y="140" fontSize="48" fill="#2196F3" fontWeight="bold" textAnchor="middle">
            {calendarDay}
          </text>
    ...
    },
    {
      ...
      svg: (isHovered) => (
        <svg viewBox="0 0 200 200" className="w-full h-full">
          ...
          <g className={isHovered ? 'trophy-code-rise' : 'trophy-code-inside'}>
          ...
          <g className={isHovered ? 'trophy-lid-open' : 'trophy-lid-close'}>
    ...
    },
    {
      ...
      svg: (isHovered) => (
        <svg viewBox="0 0 200 200" className="w-full h-full">
          ...
          {/* Connecting lines between people - animate on hover */}
    ...
    },
    {
      ...
      svg: (isHovered) => (
        <svg viewBox="0 0 200 200" className="w-full h-full">
          ...
          {/* Yellow Cloud - Draws from start point */}
          <path 
            d="M 60 100 Q 60 80 80 80 Q 80 60 110 60 Q 140 60 140 80 Q 160 80 160 100 Q 160 120 140 120 L 80 120 Q 60 120 60 100 Z" 
            fill="none" 
            stroke="#FFC107"
  ...
  return (
    <div className="hidden md:block relative w-full  bg-[#0a0a0a] overflow-hidden" style={{ height: '35vh', minHeight: '280px' }}>
      ...
      <style jsx>{`
        ...
        .calendar-dots-animate .cal-dot-1 {
          animation: dot-bounce 0.8s ease-in-out infinite;
          animation-delay: 0s;
        }
        .calendar-dots-animate .cal-dot-2 {
          animation: dot-bounce 0.8s ease-in-out infinite;
          animation-delay: 0.2s;
        }
        .calendar-dots-animate .cal-dot-3 {
          animation: dot-bounce 0.8s ease-in-out infinite;
        ...
        .trophy-lid-open {
          animation: lift-lid-realistic 0.6s ease-out forwards;
        }
        .trophy-lid-close {
          animation: close-lid-realistic 0.6s ease-out forwards;
        }
        .trophy-code-inside {
        ...
        @keyframes lift-lid-realistic {
          0% { transform: translateY(0) rotateX(0deg); }
          50% { transform: translateY(-20px) rotateX(-5deg); }
          100% { transform: translateY(-40px) rotateX(0deg); }
        }
        @keyframes close-lid-realistic {
          0% { transform: translateY(-40px) rotateX(0deg); }
          50% { transform: translateY(-20px) rotateX(5deg); }
        ...
        .cloud-data-upload .upload-dot-1 {
          animation: upload-rise 1.5s ease-out infinite;
          animation-delay: 0s;
        }
        .cloud-data-upload .upload-dot-2 {
          animation: upload-rise 1.5s ease-out infinite;
          animation-delay: 0.3s;
        }
        .cloud-data-upload .upload-dot-3 {
          animation: upload-rise 1.5s ease-out infinite;
        ...
        .notification-pop .notif-1 {
          animation: notif-bounce 0.5s ease-out 0.6s backwards;
        }
        .notification-pop .notif-2 {
          animation: notif-bounce 0.5s ease-out 0.8s backwards;
        }
        .notification-hide {
          opacity: 0;
        }
